...
if(isset($_POST['submit'])) {
   ...
   if(!$firstname) {
    ...
    if($createpassword !== $confirmpassword) {
      ...
      $user_check_query = "SELECT * FROM users2 WHERE username='$username' OR email='$email'";
   ...
   if(isset($_SESSION['add-user'])) {
    ...
    die();
        ...
        $insert_user_query = "INSERT INTO users2 (firstname, lastname, username, email, password, 
        avatar, is_admin) VALUES('$firstname', '$lastname', '$username', '$email', '$hashed_password', '$avatar_name', '$is_admin')";
        //$insert_user_query = "INSERT INTO users2 firstname='$firstname', lastname='$lastname', username='$username', email='$email', 
